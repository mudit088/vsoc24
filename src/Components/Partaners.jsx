...
const Partners = () => {
  ...
  return (
    <div name='Partners' className='w-100vh h-full pt-36 flex justify-center items-center bg-gradient-to-b from-yellow-100 to-orange-50 '>
      <div className='flex flex-col items-center'>
        <h1 className="font-display text-orange-900 mb-8 text-center font-Vsoc text-3xl font-extrabold leading-none tracking-tight sm:mb-20 md:text-5xl lg:text-6xl rightorigin">
          Partners
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-36 text-center justify-center items-center py-8 px-12 sm:px-0 mb-14 sm:mt-5 leftorigin">
